...
REM   - Crea un commit con la fecha y hora como mensaje.
REM   - Si el repositorio ya esta conectado a un remoto (origin), sube los
REM     cambios automaticamente (git push). Si no, te da las 3 instrucciones
REM     para conectarlo una sola vez.
REM
